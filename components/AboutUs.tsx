export default function AboutUs() {
  return (
    <section className="py-32 px-6 md:px-12 bg-brand-bg border-y border-brand-primary/10">
      <div className="max-w-4xl mx-auto text-center">
        <span className="text-xs uppercase tracking-[0.5em] text-brand-muted mb-12 block">
          Since 1998
        </span>
        <h2 className="text-3xl md:text-5xl font-serif leading-relaxed mb-16 text-brand-text">
          We don’t just represent models. We curate{" "}
          <span className="italic text-brand-primary">extraordinary</span>{" "}
        ...
        <div className="grid md:grid-cols-3 gap-12 text-left">
          <div>
            ...
            <p className="text-brand-muted text-sm font-light leading-loose">
