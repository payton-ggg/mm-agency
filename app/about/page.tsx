  ...
  return (
    <>
      ...
      <main className="min-h-screen pt-20">
        {/* Hero */}
        <section className="relative py-16 px-6 bg-gradient-red overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            <h1 className="mb-4">About Elite</h1>
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-xl text-gray-light leading-relaxed font-medium text-white-off">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <h3 className="mb-3 text-red-light text-xl">Excellence</h3>
              ...
              <div className="text-center">
                <h3 className="mb-3 text-red-light text-xl">Innovation</h3>
                <p className="text-gray-light text-base">
              ...
              <div className="text-center">
                <h3 className="mb-3 text-red-light text-xl">Integrity</h3>
                <p className="text-gray-light text-base">
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-light mb-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-gray-light">
              <div>
                <h4 className="text-white-off mb-2 text-lg">New York</h4>
                <p className="text-sm">Fashion Week • Commercial</p>
              </div>
              <div>
                <h4 className="text-white-off mb-2 text-lg">Paris</h4>
                <p className="text-sm">Haute Couture • Editorial</p>
              </div>
              <div>
                <h4 className="text-white-off mb-2 text-lg">Milan</h4>
                <p className="text-sm">Fashion Week • Campaigns</p>
              </div>
              <div>
                <h4 className="text-white-off mb-2 text-lg">London</h4>
